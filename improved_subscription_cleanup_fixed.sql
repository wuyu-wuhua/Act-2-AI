...
-- 1. 首先检查credit_type字段的约束
SELECT 
    conname as constraint_name,
    pg_get_constraintdef(oid) as constraint_definition
FROM pg_constraint 
WHERE conrelid = 'act_credit_transactions'::regclass 
AND conname = 'act_credit_transactions_credit_type_check';

-- 2. 改进的expire_subscription_credits函数
...
-- 3. 改进的process_expired_subscriptions函数
...
-- 4. 改进的daily_subscription_cleanup函数
